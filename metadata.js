    ...
    PLUGINS: [
      {
        ...
        thirdPartyNotices:
          "node_modules/@uplol/monaco-typescript/ThirdPartyNotices.txt",
        paths: {
          src: "/monaco-typescript/release/dev",
          "npm/dev": "node_modules/@uplol/monaco-typescript/release/dev",
          "npm/min": "node_modules/@uplol/monaco-typescript/release/min",
          esm: "node_modules/@uplol/monaco-typescript/release/esm",
        },
      },
      {
        name: "monaco-css",
